...
namespace WebUI.Controllers
{
    ...
    public class AuthorController : BaseController
    {
        ...
        public async Task<ActionResult> UpdateAuthorAsync(Guid id, UpdateAuthorCommand command)
        {
            if (id != command.Id) return StatusCode(StatusCodes.Status400BadRequest);
            return Ok(await Mediator.Send(command));
        }
