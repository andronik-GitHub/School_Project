...
namespace SchoolLibrary_EF.API.Controllers
{
    ...
    public class BookAuthorsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<BookAuthorsDTO>>> GetAllAsync()
        {
            try
            {
                var collection = await _bookAuthorsService.GetAllAsync();
                _logger.LogInformation("All entities were successfully extracted from [BookAuthors]");
